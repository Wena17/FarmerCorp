    ...
    <section class="page-section about-heading">
        <div class="container">
            <div class="card shadow-lg mb-4 bgColor">
                ...
                <div class="card-body">
                    <label id="lblSaleStatus" class="h3 font-weight-bold text-center" runat="server" visible="false"></label>
                    <asp:GridView CssClass="table container" ID="salesView" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">               
                        <Columns>                        
